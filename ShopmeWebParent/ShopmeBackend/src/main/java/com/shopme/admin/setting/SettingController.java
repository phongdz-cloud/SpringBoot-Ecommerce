...
public class SettingController {
	...
	private void updateSettingValuesFormForm(HttpServletRequest request, List<Setting> listSettings) {
		for(Setting setting : listSettings) {
	...
	public String saveMailServerSettings(HttpServletRequest request, RedirectAttributes ra) {
		...
		updateSettingValuesFormForm(request, mailServerSettings);
	...
	public String saveMailTemplateSettings(HttpServletRequest request, RedirectAttributes ra) {
		...
		updateSettingValuesFormForm(request, mailTemplateSettings);
